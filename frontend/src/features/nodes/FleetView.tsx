...
const cardCls = "rounded-xl transition-all duration-300 bg-[var(--surface-card)] border border-[var(--card-border)] shadow-[var(--shadow-card-lite)] hover:border-[var(--card-border-hover)]";
