      ...
      <div className="relative -mx-1 border-b border-white/[0.06] pb-7">
        <div className="flex items-start justify-between gap-8">
          <div className="flex items-start gap-5 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-3 flex-wrap">
                <h1 className="text-[26px] font-bold leading-tight tracking-[-0.015em] text-white">{node.display_name}</h1>
              ...
              <div className="mt-2 flex items-center gap-x-5 gap-y-1 text-[12px] text-gray-500 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            >
              {node.is_enabled ? i18n.nodeDetail.actions.disableNode : i18n.nodeDetail.actions.enableNode}
            </button>
          </div>
        </div>
          ...
          {tabs.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative pb-3.5 pt-1 text-[13.5px] font-semibold transition-colors ${
